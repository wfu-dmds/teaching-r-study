...
shiny::sliderInput(inputId = "r-competence-1",
...
shiny::sliderInput(inputId = "r-master-eventually-1",
...
shiny::sliderInput(inputId = "r-enjoy-learning-1",
...
```{r ex2_question1, echo = FALSE}
shiny::numericInput("ex2-1",
...
```{r ex2_question2, echo = FALSE}
shiny::numericInput("ex3-1",
