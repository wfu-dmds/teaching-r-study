...
save_assessments <- function(assessment_number, username) {
  ...
  assessment_ids <- paste0(c("r-competence-", "r-master-eventually-", "r-enjoy-learning-"), assessment_number)
...
update_assessments <- function(number) {
  ...
  shiny::observeEvent(
    input[[paste0("r-competence-", number)]] | input[[paste0("r-master-eventually-", number)]] | input[[paste0("r-enjoy-learning-", number)]], 
    {
